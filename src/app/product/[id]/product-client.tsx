...
export default function ProductClient({
  ...
  useEffect(() => {
    if (selectedSize && selectedColor && product.stock) {
      const key =
        `${selectedSize}-${selectedColor}` as keyof typeof product.stock;
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="p-4">
            ...
            <div className="mb-6">
              ...
              <div
                className={`flex ${isMobile ? "flex-wrap gap-2" : "space-x-2"}`}
              >
              ...
              <div className="flex flex-wrap gap-2">
                {productSizes.map((size) => {
                  const inStock =
                    ...
                    (selectedColor &&
                      (product.stock[
                        `${size}-${selectedColor}` as keyof typeof product.stock
                      ] || 0) > 0);
            ...
            <div className="flex space-x-3 mb-4">
              <button
                ...
                disabled={
                  !selectedSize ||
                  !selectedColor ||
                  (product.stock && stockAvailable === 0) ||
                  !isAuthenticated
                }
            ...
            {selectedSize &&
              ...
              stockAvailable === 0 && (
                <p className="text-red-500 mb-1">
                  Size Not Available! Out of Stock! 2 Products Remaining..! 😢
                </p>
              )}
            {selectedSize &&
              selectedColor &&
            ...
            {(!selectedSize || !selectedColor) && (
              <p className="text-gray-400 mb-1">Please select color and size</p>
            )}
          </div>
        </div>
